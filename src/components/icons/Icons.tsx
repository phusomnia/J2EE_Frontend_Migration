...
export function LinkedinIconFA({
    ...
    return (
        <svg
            ...
            height={size}
            viewBox="0 0 640 640"
            className={`fa-linkedin ${className}`}
        >
...
export function FacebookIconFA({
    size = 24,
    color = "currentColor",
    className = "",
}) {
    return (
        <svg
            ...
            viewBox="0 0 640 640"
            fill={color}
            className={`fa-facebook ${className}`}
        >
