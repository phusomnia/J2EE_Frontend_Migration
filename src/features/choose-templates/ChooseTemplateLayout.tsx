...
import { TemplateA } from "./component/templates"
        ...
        <div className="template-detail flex">
            ...
            <div className="template-information border w-full p-4">
                <div className="flex gap-2">
                    <div className="tag rounded border-2">
                        Sáng tạo
                    </div>
                    <div className="tag rounded border-2">
                        Khuyến khích
                ...
                <ul>
                    <div><span>&#10003;</span> Tối ưu hóa cho ATS (Hệ thống theo dõi ứng viên)</div>
                    <div><span>&#10003;</span> CV 2 cột</div>
                    <div><span>&#10003;</span> Nội dung mẫu có thể chỉnh sửa</div>
                    <div><span>&#10003;</span> Tải xuống dưới định dạng PDF, Word DOCX hoặc TXT</div>
                </ul>
                <button 
                    className="
...
function TemplateLayout({children}: any)
{
    const scale = useScaleContext();
...
}: any)
{
    ...
    return <>
        <div 
            className="template-card relative group h-full"
        >
            {/* Overlay */}
            <div 
                className="
