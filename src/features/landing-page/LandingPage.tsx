        ...
        <div className="h-screen w-screen bg-gray-100">
            <div className="grid grid-cols-2 mx-auto p-4">
                <div className="relative">
                    ...
                    <div className="flex gap-8">
                        <div className="">
                            <button
                                className="p-4 rounded-lg bg-orange-500 hover:bg-amber-50 hover:scale-105 transition-transform duration-300"
                            >
                                Tạo CV
                            </button>
                        </div>
                        <div className="space-y-2">
                            <div className="">
                                <button
                                    className="p-4 rounded-lg bg-blue-500 hover:bg-amber-50 hover:scale-105 transition-transform duration-300"
                                >
                                    Nâng cấp cv
                                </button>
                            </div>
                ...
                <div className="relative">
                    <div
                        className="absolute -top-20 -right-20 w-64 h-64 bg-primary-200 rounded-full filter blur-3xl opacity-30"></div>
                    <div
                        className="absolute -bottom-8 -left-8 w-40 h-40 bg-purple-300 rounded-full filter blur-3xl opacity-20"></div>
                    <div
                        className="relative bg-white p-4 rounded-xl shadow-xl transform rotate-2 hover:rotate-0 transition-all">
                        <img 
                        src="" 
                        alt="style resume example" 
                        className="rounded-lg w-full object-cover h-[400px]"
                        />
                        <div className="absolute -bottom-5 -right-5 bg-white p-3 rounded-full shadow-lg transform rotate-12 hover:rotate-0 transition-all">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto p-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">Vì sao bạn lại chọn sản phẩm của chúng tôi?</h2>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Tạo ra những bản sơ yếu lý lịch với những mẫu sáng tạo, giúp hồ sơ bạn trở nên nổi bật hơn
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 mx-auto">
                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 border border-gray-100">
                        <h3 className="text-xl font-bold mb-2">Thiết kế độc đáo</h3>
                        <p className="text-gray-600">Nhiều mẫu tùy chỉnh, phù hợp với cá tính và nghành nghề của bạn</p>
                    </div>

                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 border border-gray-100">
                        <h3 className="text-xl font-bold mb-2">Tạo mẫu nhanh chóng</h3>
                        <p className="text-gray-600">Tạo sơ yếu lý lịch chuyên nghiệp trong vài phút với giao diện trực quan và dễ sử dụng của chúng tôi</p>
                    </div>

                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 border border-gray-100">
                        <h3 className="text-xl font-bold mb-2">Thân thiện với ATS</h3>
                        <p className="text-gray-600">Tương thích với hệ thống ATS để vượt qua vòng sàng lọc tự động</p>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 border border-gray-100">
                        <h3 className="text-xl font-bold mb-2">Hỗ trợ đa nền tảng</h3>
                        <p className="text-gray-600">Tải xuống sơ yếu lý lịch của bạn ở định dạng PDF, PNG hoặc chia sẻ trực tiếp lên mạng xã hội hoặc các nền tảng việc làm của bạn</p>
                    </div>

                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-2 border border-gray-100">
                        <h3 className="text-xl font-bold mb-2">Hỗ trợ bởi AI</h3>
                        <p className="text-gray-600">AI của chúng tôi gợi ý phong cách, màu sắc và bố cục hoàn hảo dựa trên nghề nghiệp và sở thích của bạn</p>
                    </div>
                </div>
            </div>
            ...
            <section className="py-16 md:py-20">
                ...
                <div className="max-w-3xl mx-auto text-center text-white">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-black">Chuẩn bị tạo mẫu cho sơ yếu lý lịch chưa?</h2>
                    <p className="text-xl mb-8 text-primary-100 text-black">
                        Hãy gia nhập cùng với 10.000 ứng viên đã tìm được công việc mơ ước nhờ các mẫu sơ yếu lý lịch độc đáo của chúng tôi
                    </p>
